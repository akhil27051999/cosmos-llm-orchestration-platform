...
Originally a 5-endpoint Student CRUD (Flask + Postgres). I am scaling it into **"Helios"** — an
...
This Mac: 10 cores, 16 GB RAM, ~78 GB free. ~90% of Helios builds & runs locally for free
